...
9 is based on fastapi_app_v6 with OCR-focused image preprocessing tuning.
...
async def preprocess_image_async(image: Image.Image) -> Image.Image:
    ...
    try:
        ...
        logger.error(f"Image preprocessing failed in v9: {e}")
        return image
...
base.app.title = "BLIP3o OCR API v9.0"
base.app.description = "v6 API with OCR-tuned image preprocessing for clearer text recognition"


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="BLIP3o OCR FastAPI Server v9")
    ...
    logger.info("Initializing BLIP3o OCR FastAPI Server 9...")
